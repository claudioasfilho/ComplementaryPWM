...
void initTimer(void)
{
  ...
  timerDTIInit.autoRestart = true;
  timerDTIInit.activeLowOut = true;
  //timerDTIInit.invertComplementaryOut = true;
  ...
  GPIO->TIMERROUTE[0].ROUTEEN  |= GPIO_TIMER_ROUTEEN_CCC0PEN;
  ...
  TIMER_InitDTI(TIMER0, &timerDTIInit);
